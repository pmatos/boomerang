...
POINT ?MoveTo@CDC@@QAE?AVCPoint@@HH@Z(  /* CDC::MoveTo */
	CDC *this,
	POINT *ret,  /* MSVC convention when returning structs is to pass a hidden first parameter, actually second here */
	int x,
	int y);
...
void ??0CString@@QAE@PBD@Z(CString *this, char *sz);  /* CString constructor with C string */
