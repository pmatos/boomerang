...
int __vsnprintf_chk(char *buf, size_t sz @max(buf), int n, size_t m, const char *s, va_list args);
int __snprintf_chk(char *buf, size_t sz @max(buf), int n, size_t m, const char *s, ...);
