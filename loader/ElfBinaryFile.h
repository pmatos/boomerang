...
private:
	...
	// Internal elf reading methods
	        ...
	        std::map<ADDRESS, std::string> m_SymTab;    // Map from address to symbol name; contains symbols from the various
	                                                    // elf symbol tables, and possibly some symbols with fake addresses
